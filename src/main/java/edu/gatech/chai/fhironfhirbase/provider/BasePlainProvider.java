...
public abstract class BasePlainProvider {
	private static final Logger logger = LoggerFactory.getLogger(BasePlainProvider.class);
	...
	public BasePlainProvider(FhirContext ctx) {
		this.ctx = ctx;
	}
